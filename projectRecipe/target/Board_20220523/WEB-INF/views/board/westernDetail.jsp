...
<%--                &lt;%&ndash;                <table>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    <th><a href="/member/save-form" class="logo"><strong>회원가입</strong></a></th>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    <th><a href="/member/login-form" class="logo"><strong>로그인</strong></a></th>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    <th><a href="/board/paging" class="logo"><strong>글목록</strong></a></th>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                </table>&ndash;%&gt;--%>
...
<%--                    &lt;%&ndash; 삭제처리 &ndash;%&gt;--%>
<%--                    <c:if test="${sessionScope.loginMemberId eq board.boardWriter or sessionScope.loginMemberId == 'admin'}"><a href="/board/westernDelete?id=${board.id}"role="button" class="button big">삭제</a></c:if>&nbsp;--%>
<%--                    <a href="/board/koreanPaging" class="button big">글목록</a>--%>
<%--                </div>--%>
<%--                <div class="container mb-5">--%>
<%--                    <div id="westernComment-write" class="input-group mb-3">--%>
<%--                        <div class="form-floating">--%>
<%--                            <input type="text" id="commentWriter" class="form-control" value="${sessionScope.loginMemberId}" readonly>--%>
<%--                            &lt;%&ndash;                <label for="commentWriter">작성자</label>&ndash;%&gt;--%>
<%--                        </div>--%>
<%--                        <div class="form-floating">--%>
<%--                            <input type="text" id="commentContents" class="form-control" placeholder="내용">--%>
<%--                            <label for="commentContents">내용</label><br>--%>
<%--                        </div>--%>
<%--                        <button id="westernComment-write-btn" class="btn btn-primary">댓글작성</button>--%>
<%--                    </div>--%>
<%--                </div>--%>

<%--                    <div id="westernComment-list">--%>
<%--                        <table class="table">--%>
<%--                            <tr>--%>
<%--                                <th>댓글번호</th>--%>
<%--                                <th>작성자</th>--%>
...
<%--                                <th>작성시간</th>--%>
<%--                            </tr>--%>
<%--                            <c:forEach items="${westernCommentList}" var="comment">--%>
<%--                                <tr>--%>
<%--                                    <td>${comment.id}</td>--%>
<%--                                    <td>${comment.commentWriter}</td>--%>
<%--                                    <td>${comment.commentContents}</td>--%>
<%--                                    <td><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${comment.commentCreatedDate}"></fmt:formatDate></td>  &lt;%&ndash; 초 까지만 나옴. &ndash;%&gt;--%>
<%--                                </tr>--%>
<%--                            </c:forEach>--%>
<%--                        </table>--%>
...
<%--</body>--%>
<%--<script>--%>
<%--    $("#westernComment-write-btn").click(function (){--%>
<%--        // alert("나 눌렀어?");--%>
<%--        // 댓글 작성자, 내용을 가져오고--%>
...
<%--                }--%>
<%--                output += "</table>";--%>
<%--                document.getElementById('westernComment-list').innerHTML = output;--%>
...
<%--        location.href = "/board/westernUpdate?id=${board.id}";--%>
<%--    }--%>

<%--    &lt;%&ndash;const boardDelete = () => {&ndash;%&gt;--%>
<%--    &lt;%&ndash;    // 비밀번호 체크를 위한 화면(passwordCheck.jsp)을 출력하고, 비밀번호 입력받아서&ndash;%&gt;--%>
<%--    &lt;%&ndash;    // 비밀번호 일치하면 삭제처리 후 목록 출력, 일치하지 않으면 alert 띄우고 상세화면으로&ndash;%&gt;--%>
<%--    &lt;%&ndash;    location.href = "/board/passwordCheck?id=${board.id}";&ndash;%&gt;--%>
<%--    &lt;%&ndash;}&ndash;%&gt;--%>

<%--    const westernWritePaging = () => {--%>
<%--        location.href = "/board/westernWritePaging?page=${page}"; // 직전에 있었던 페이지 값을 컨트롤러로 요청--%>
<%--    }--%>
<%--</script>--%>
<%--</html>--%>
