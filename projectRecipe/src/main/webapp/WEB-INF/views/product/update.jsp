        ...
        <div class="inner">
            ...
            <section id="banner">
                <div class="content">
                    ...
                    <div class="container">
                        <h2 class="display-4 fw-normal">상품 수정</h2>
                        <div class="py-5 text-center">
                            <form action="/product/update-form" method="post" name="update">
                                상품번호: <input class="form-control mb-2" type="text" name="id" value="${update.id}" readonly>
                                상품명: <input class="form-control mb-2" type="text" name="productName" value="${update.productName}">
                                상품가격: <input class="form-control mb-2" type="text" name="productPrice" value="${update.productPrice}">
