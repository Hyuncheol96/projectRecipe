        ...
        <div class="inner">
            ...
            <section id="banner">
                <div class="container">
                    ...
                    <br><c:if test="${sessionScope.loginMemberId eq board.boardWriter}"><button class="btn btn-primary" onclick="koreanUpdate()">수정</button></c:if>&nbsp;
                    <%-- 삭제처리 --%>
                    ...
                    <a href="/board/koreanPaging" class="btn btn-primary">글목록</a>
                </div>
...
<script>
    ...
    const koreanUpdate = () => {
        ...
        location.href = "/board/koreanUpdate?id=${board.id}";
    }
    ...
    const koreanWritePaging = () => {
        location.href = "/board/koreanWritePaging?page=${page}"; // 직전에 있었던 페이지 값을 컨트롤러로 요청
    }
</script>
</html>
